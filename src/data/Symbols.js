  ...
  //希腊字母
  {
    ...
    TitleCaseLetters: [
      ...
      },
      {
        ...
        case: 'upper',
        letters: {
          Alpha: '\\Alpha', // Α (通常与 A 相同，不常用)
          Beta: '\\Beta', // Β (通常与 B 相同，不常用)
          Gamma: '\\Gamma', // Γ
          Delta: '\\Delta', // Δ
          Epsilon: '\\Epsilon', // Ε (通常与 E 相同，不常用)
          Zeta: '\\Zeta', // Ζ (通常与 Z 相同，不常用)
          Eta: '\\Eta', // Η (通常与 H 相同，不常用)
          Theta: '\\Theta', // Θ
          Iota: '\\Iota', // Ι (通常与 I 相同，不常用)
          Kappa: '\\Kappa', // Κ (通常与 K 相同，不常用)
          Lambda: '\\Lambda', // Λ
          Mu: '\\Mu', // Μ
          Nu: '\\Nu', // Ν
          Xi: '\\Xi', // Ξ
          Omicron: '\\Omicron', // Ο (通常与 O 相同，不常用)
          Pi: '\\Pi', // Π
          Rho: '\\Rho', // Ρ (通常与 P 相同，不常用)
          Sigma: '\\Sigma', // Σ
          Tau: '\\Tau', // Τ (通常与 T 相同，不常用)
          Upsilon: '\\Upsilon', // Υ
          Phi: '\\Phi', // Φ
          Chi: '\\Chi', // Χ
          Psi: '\\Psi', // Ψ
